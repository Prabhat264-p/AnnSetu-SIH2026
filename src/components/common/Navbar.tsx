          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-semibold text-[#1a1c1a] bg-[#ffffff] border border-[#c1c8c2]/70 px-2.5 py-1.5 rounded-lg hover:border-[#012d1d] transition-colors shadow-xs cursor-pointer"
              >
              ...
              {showLangMenu && (
                <div className="absolute right-0 mt-2 w-44 bg-white rounded-xl shadow-lg border border-[#c1c8c2]/50 py-1 z-50">
                  {(['en', 'hi', 'mr', 'bn', 'te'] as Language[]).map((lang) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 text-xs flex items-center justify-between hover:bg-[#f3f4f1] cursor-pointer ${
                        language === lang ? 'font-bold text-[#012d1d] bg-[#aeeecb]/30' : 'text-[#414844]'
                      }`}
                    >
                      <span>
                        {lang === 'en'
                      ...
                      {language === lang && <CheckCircle className="w-3.5 h-3.5 text-[#2c694e]" />}
                    </button>
                  ))}
                </div>
              )}
